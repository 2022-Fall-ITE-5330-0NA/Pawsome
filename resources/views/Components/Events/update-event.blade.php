                ...
                <div class="p-10 space-y-7">
                        ...
                        <div class="line mb-4">
                            <input class="line__input" id="" name="name" type="text"
                                   onkeyup="this.setAttribute('value', this.value);" value="{{$event->name}}"
                                   autocomplete="off">
                            <span for="username" class="line__placeholder"> Event Name </span>
                        </div>

                        <div class="line h-32">
                            <textarea class="line__input h-80" id="" name="description" type="text"
                                      onkeyup="this.setAttribute('value', this.value);" value="{{$event->description}}"
                                      autocomplete="off"></textarea>
                            <span for="username" class="line__placeholder"> Event description </span>
                        </div>

                        <div class="line mt-4">
                            <label for="input">Upload Event Picture</label>
                            <input id="input" class="line" type="file" name="picture" />
                        </div>

                        <div>
                            <input hidden name="author_id" value="admin"></input>
                        </div>
