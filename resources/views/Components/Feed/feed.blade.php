                        ...
                        <div class="flex justify-between items-center lg:p-4 p-2.5">
                            <div class="flex flex-1 items-center space-x-4">
                                ...
                                <div class="flex-1 font-semibold capitalize">
                                    <a href="#" class="text-black"> {{$post->author_id}} </a>
                    ...
                    <a href="#birthdays" uk-toggle>
                        <div class="bg-white mb-5 px-4 py-3 rounded-md shadow">
                            ...
                            <div class="-mx-2 duration-300 flex hover:bg-gray-50 px-2 py-2 rounded-md">
                                ...
                                <p class="line-clamp-2 leading-6"><strong> Jessica Erica </strong> and <strong> two
                                        others </strong>
                                ...
                                <div class="contact-list-box">
                                    ...
                                    <div class="contact-list-box-btns">
                                        <button type="button" class="button primary flex-1 block mr-2">
                                            <i class="uil-envelope mr-1"></i> Send message
                                        </button>
        ...
        <form method="POST" action="/feed" enctype="multipart/form-data">
            ...
            <div class="flex flex-1 items-start space-x-4 p-5">
                ...
                <div class="flex-1 pt-2">
                    <input name="author_id" value="admin" hidden />
                    <textarea
